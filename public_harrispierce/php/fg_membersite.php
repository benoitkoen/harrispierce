...
class FGMembersite
{
    ...
    {
        $this->sitename = 'harrispierce.com';
        $this->rand_key = 'XpgEgq7az9eX8LP'; //XpgEgq7az9eX8LP ORI: 0iQx5oBk66oVZep
    }
    ...
    function Login()
    {
        ...
        //header("Location: access-controlled.php"); //exit;
    ...
    function CheckLoginInDB($email,$password)
    {
        ...
        $pwdmd5 = md5($password);
        $qry = "Select email from $this->tablename where email='$email' and password='$pwdmd5'";
    ...
    */
    ...
    function DBLogin()
    {
        ...
        if(!mysqli_select_db($this->connection, $this->database)) //wrong order
        {
    ...
    */
    ...
    function SanitizeForSQL($str)
    {
        ...
        {
              $ret_str = addslashes($this->connection, $str );
        }
        return $ret_str;
    }
